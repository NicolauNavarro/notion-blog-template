...
export default async function Home() {
  ...
  return (
    <>
      <main className="prose prose-neutral max-w-prose mx-auto w-full px-4 overflow-hidden flex flex-col justify-center border-b-2 border-gray-200 pb-8">
      ...
      {posts.map((post) => (
        <Link
          key={post.slug}
          href={`/${post.slug}`}
          className="prose prose-neutral max-w-prose mx-auto w-full overflow-hidden flex flex-col justify-center gap-4 rounded-xl p-4 hover:bg-gray-100 transition-colors relative active:bg-gray-100"
        >
